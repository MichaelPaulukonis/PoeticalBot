...
'No matter who owns P. S. of New Hampshire, after it emerges from bankruptcy proceedings its rates will be among the highest in the nation, he said.',
...
'The S. E. C. documents describe those chips, which are made of gallium arsenide, as being so fragile and minute they will require special robotic handling equipment.',
...
'The latest two funds were assembled jointly by Goldman, Sachs & Company of the U. S. and Japan\'s Daiwa Securities Company.',
...
'The government\'s construction spending figures contrast with a report issued earlier in the week by McGraw-Hill Incorporated\'s F. W. Dodge Group.',
...
'"My teacher said it was O. K. for me to use the notes on the test," he said.',
...
'"Only five of the forty questions were geography questions.',
'The rest were history, sociology, finance -- subjects they never had."',
'Mr. Watson says Mrs. Yeargin never complained to school officials that the standardized test was unfair.',
'"Do I have much sympathy for her?"',
'Mr. Watson asks.',
'"Not really.',
...
'Many attorneys have returned incomplete forms to the I. R. S. in recent years, citing attorney-client privilege.',
'Until last week, the I. R. S. rarely acted on the incomplete forms.',
...
'N. E. C., one of its largest domestic competitors, said it bid one yen in two separate public auctions since nineteen eighty seven.',
'In both cases, N. E. C. lost the contract to Fujitsu, which made the same bid and won a tie-breaking lottery.',
...
'But some of the T. V. stations that bought" Cosby" reruns for record prices two years ago aren\'t laughing much these days.',
'The reruns have helped ratings at many of the one eighty seven network affiliates and independent T. V. stations that air the shows.',
...
'Late yesterday, Georgia Gulf said it reviewed the N. L. proposal as well as interests from" third parties" regarding business combinations.',
...
'Mr. Simmons and N. L. already own a nine .point nine percent stake in Georgia Gulf.',
...
'Since then, a team of about fifteen M. I. T. I. and U. S. Commerce Department officials have crossed the globe gauging consumer prices.',
...
'And an F. T.-S. E. futures contract is traded on the London International Financial Futures Exchange.',
...
'A U. S. X. spokesman said the company hadn\'t yet received any documents from OSHA regarding the penalty or fine.',
...
'Under that law, parties proposing mergers or acquisitions valued at fifteen million dollars or more must notify F. T. C. and Justice Department antitrust regulators before completing the transactions.',
...
'"These two exposures alone represent a very substantial portion of C. S. First Boston\'s equity," Moody\'s said.',
'"Total merchant banking exposures are in excess of the firm\'s equity."',
'C. S. First Boston, however, benefits from the backing of its largest shareholder, Credit Suisse, Switzerland\'s third largest bank.',
...
'D. E. S. daughters and other victims of drugs would be better off if their cases were taken out of the courts.',
...
'We have no doubt this is one reason judges in New York and justices on the Supreme Court are willing to trash the law in the D. E. S. cases.',
...
'Glaxo, the U. K.\'s largest pharmaceutical concern, advanced twenty three to fourteen pounds and thirteen pence.',
...
'U. A. L.\'s announcement came after the market closed yesterday.',
...
'U. A. L. wouldn\'t elaborate on a statement that it had been notified of the filing by Reliance.',
...
'Its subsidiaries\' services are marketed by closely held A. L. Williams & Associates.',
...
'D. D. Acquisition said the extension is to allow this process to be completed.',
...
'The assistant H. H. S. secretary said the ban" should be continued indefinitely."',
...
'Peter Marcus, an analyst with PaineWebber Incorporated, said that a downturn in the appliance industry, coupled with sluggish automotive sales, hurt U. S. X. results.',
'Moreover, U. S. X. exports more than other steelmakers, and the overseas market has been under more severe pricing pressure.',
...
'U. S. X. announced in October that it was soliciting bids to sell T. X. O.\'s oil and gas reserves.',
...
'Many investors wrote asking the S. E. C. to require insiders to report their purchases and sales immediately, not a month later.',
'But Mr. Lane said that while the S. E. C. regulates who files, the law tells them when to do so.',
'Investors who want to change the required timing should write their representatives in Congress, he added.',
'The S. E. C. would likely be amenable to legislation that required insiders to file transactions on a more timely basis, he said.',
...
'But G. M. officials said they, too, were surprised by the move, which left them to" consider all our options and explore matters further."',
'Although G. M. has U. S. approval to buy up to fifteen percent of Jaguar\'s stock, it hasn\'t yet disclosed how many shares it now owns.',
'At the same time, the government didn\'t want to appear to favor G. M. by allowing a minority stake that might preclude a full bid by Ford.',
...
'"This week was uneventful for the C. D. market," said Norberto Mehl, chairman of Banxquote.',
'"The major banks haven\'t even reacted to sharp rises in the three-month Treasury bill rates" in the past two weeks.',
'Banks that adjusted payouts on C. D.s in the most recent week made only fractional moves, he said.',
'The C. D. trend runs counter to the direction of short-term interest rates at the Treasury bill auction Monday.',
...
'However, C. D.s sold through major broker-dealer networks were up slightly almost across the board.',
'The average six-month C. D. in that category added zero .point zero five percentage point to eight .point three five percent, for example.',
...
'The F. B. I. initially showed little interest, and he had the impression other federal security agencies were tangled up in legal red tape.',
'The C. I. A. told him it does not do domestic counterespionage.',
'One learns a lot from this book, or seems to, about crippling federal bureaucracy.',
'"Seems to" because it\'s possible that the C. I. A. and the National Security Agency were more interested than they let on to Mr. Stoll.',
'The new Mips machine, called the R. C. sixty two eighty, will cost one hundred fifty thousand dollars for a basic system.',
...
'The R. T. C. has projected that it will require between fifty billion dollars to one hundred billion dollars in temporary working capital.',
'The borrowing to raise these funds would be paid off as assets of sick thrifts are sold.',
'The new S. & L. law allows the R. T. C. to issue notes for as much as eighty five percent of the value of the assets it holds.',
...
'Although the current management team may be outstanding, who will be the C. E. O. in ten years?',
...
'Instead, Sony is likely to agree to let Warner participate in certain of its businesses, such as the record club of Sony\'s C. B. S. Records unit.',
'Warner has surpassed Sony as the largest record company, but it doesn\'t have a powerful world-wide record club like C. B. S..',
...
'Last year, J. & B. Scotch offered five hundred T. W. A. frequent flier miles in exchange for a label.',
...
'Seagram asks customers to buy only two or three bottles over a twelve-month period, says Richard Shaw, vice president of U. S. direct marketing.',
...
'American officials have said that a meeting with the leader of the U. S. could help bolster his stature among Soviet politicians and academics, whose support he needs.',
...
'I. R. A. BALANCES could be used to qualify for bank services under a bill entered by Reps. Chandler (R., Washington).',
...
'Ad agencies typically earned a straight fifteen percent commission; if a client spent one hundred million dollars on T. V. time, the agency made fifteen million dollars.',
...
'That\'s another reason {LEFT-BRACE for the Backer Spielvogel job }RIGHT-BRACE.',
...
'Doctor Levy\'s answer may come with a new kind of magnetic brain probe, a device that he and dozens of U. S. researchers are studying with great hope.',
...
'Since then, at least two commercial versions have been put on the U. S. market, and an estimated five hundred have been sold.',
...
'Other Senators want to lower the down payments required on F. H. A.-insured loans.',
'Of course, self-reform is about the last thing this Congress is interested in.',
'Proponents of expanding F. H. A. programs say they merely want to help home buyers who are frozen out of high-priced markets.',
'But the F. H. A. program is hemorrhaging bad loans.',
...
'At eleven .point one percent of gross national product, U. S. health costs already are the highest in the world.',
'By contrast, Japan\'s equal six .point seven percent of G. N. P., a nation\'s total output of goods and services.',
